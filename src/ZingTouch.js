...
var ZingTouch = {
   ...
   * @param {string|Object} gesture - Either a string, or a Gesture object.
   ...
   * @param {element|string} element - Retrieves either the element to remove or a qualified string to pass to querySelector
